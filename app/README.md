...
- 🗔 **GUI** — `python main.py` (o `python main.py --gui`): ventana Tkinter con selección de archivos, formatos, voz, idioma de la voz y parámetros del TTS, tema claro/oscuro, estilo Material/Neumorfismo/Skeuomorfismo, idioma de la interfaz (ES/EN) y botón "Escuchar", sin necesidad de la terminal.
...
- En la GUI: tema claro/oscuro y estilo Material/Neumorfismo/Skeuomorfismo, idioma de la interfaz ES/EN (ventana `⚙` de ajustes, se aplican y guardan al instante) e **idioma de la voz** (31 idiomas + auto).
...
- `⚙` **Ajustes**: tema (claro/oscuro), estilo (Material/Neumorfismo/Skeuomorfismo) e idioma de la interfaz (español/inglés); se aplican al instante y quedan guardados entre sesiones.
